<?php
class Rifa_Tipo_1 implements iRifa
{
    ...
    function validar_boletos_antes_compra($boletos, $id_rifa)
    {
        ...
        /*Checar que se agarra la cantidad de boletos valida*/
        ...
        if ($continue === false) {
            throw new Exception('Cantidad de boletos no valida');
        }

        /*Checar si os boletos estan dentro del rango*/
